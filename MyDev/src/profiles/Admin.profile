...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Case-Case Origin is Email</layout>
        <recordType>Case.caseRecordType2</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Case Origin is Phone</layout>
        <recordType>Case.caseRecordType1</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Case Origin is Web</layout>
    ...
    <layoutAssignments>
        <layout>Lead-pageLayout1</layout>
        <recordType>Lead.rectype1</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Lead-pageLayout2</layout>
